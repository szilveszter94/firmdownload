...
correct_page_number = math.ceil(page_number / ITEMS_PER_PAGE)
for page_num in range(FIRST_PAGE, correct_page_number + 1):  ##  the number of all pages (the +1 is because the loop run from 1 - e.g 24, but the 24 is not included)
